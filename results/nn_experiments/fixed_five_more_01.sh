...
./../../TypeCNN_nn_five_more --type-info -c net.xml -v ../../resources/mnist/test-images.idx3-ubyte -t ../../resources/mnist/train-images.idx3-ubyte -e 5 -s 456852 --optimizer sgd --loss-function MSE --periodic-validation --periodic-output 5000 --do-not-save -l 0.01
