echo "== Training on Fixed Point from beginning (0.01) =="
...
./../../TypeCNN_nn_begin --type-info -c net.xml -v ../../resources/mnist/test-images.idx3-ubyte -t ../../resources/mnist/train-images.idx3-ubyte -e 10 -s 456852 --optimizer sgdm --loss-function MSE --periodic-validation --periodic-output 5000 --do-not-load --do-not-save -l 0.01
