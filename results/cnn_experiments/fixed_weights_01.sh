echo "== 8,8 for inference, given type for weights (0.01) =="
...
./../../TypeCNN_cnn_fixed_weights --type-info -c net.xml -v ../../resources/mnist/test-images.idx3-ubyte -t ../../resources/mnist/train-images.idx3-ubyte -e 5 -s 8786 --optimizer sgd --loss-function MSE --periodic-validation --periodic-output 5000 --do-not-save -l 0.01
